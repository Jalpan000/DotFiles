...
myScratchPads = [ NS "terminal" spawnTerm findTerm manageTerm
                , NS "clementine" spawnClementine findClementine manageClementine
    ...
    where
        ...
        manageTerm = customFloating $ W.RationalRect l t w h
            where
                ...
                t = 0.95 -h
                l = 0.95 -w
        spawnClementine  = myTerminal ++ " -t clementine -e clementine"
        findClementine   = title =? "clementine"
        manageClementine = customFloating $ W.RationalRect l t w h
            where
                h = 0.9
                w = 0.9
                t = 0.95 -h
...
myKeys =
    ...
    -- KB_GROUP Useful programs to have a keybinding for launch
        ...
        , ("M-b", spawn (myBrowser ++ " https://my.rutgers.edu/portal/render.userLayoutRootNode.uP"))
    ...
    -- Toggle them to hide and it sends them back to hidden workspace (NSP).
        , ("M1-l t", namedScratchpadAction myScratchPads "terminal")
        , ("M1-l m", namedScratchpadAction myScratchPads "clementine")
        , ("M1-l c", namedScratchpadAction myScratchPads "calculator")

    -- KB_GROUP Controls for clementine music player (SUPER-u followed by a key)
        , ("M-u p", spawn "clementine -p")
        , ("M-u l", spawn "clementine -f")
        , ("M-u h", spawn "clementine -r")
        , ("M-u <Space>", spawn "clementine -t")
